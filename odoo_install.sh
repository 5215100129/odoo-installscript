#!/bin/bash
#######################################################################################
# Script for installing Odoo 10.0 on Ubuntu 16.04 (could be used for other version too)
...
# When using 'trunk' the master version will be installed.
# This script contains extra libraries that are specifically needed for Odoo 10.0.
OE_VERSION="10.0"
...
## for other distributions please replace these two links,
## in order to have correct version of WKHTMLTOX installed
## for a danger note refer to https://www.odoo.com/documentation/8.0/setup/install.html#deb
...
if [ $INSTALL_WKHTMLTOPDF = "true" ]; then
  echo -e "\n---- Install WKHTMLTOPDF and place shortcuts on correct place for Odoo 10.0 ----"
